...
namespace SSB
{
    ...
    bool GETestWindow::Init()
    {
        ...
        _background->SetTexture(TextureManager::GetInstance().Load(L"KGCABK.bmp", DXStateManager::kDefaultWrapSample));
        ...
        _object->SetTexture(TextureManager::GetInstance().Load(L"bitmap1.bmp", DXStateManager::kDefaultWrapSample));
        _object->SetMaskTexture(TextureManager::GetInstance().Load(L"bitmap2.bmp", DXStateManager::kDefaultWrapSample));
