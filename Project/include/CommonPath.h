...
const static std::wstring kShaderPath = L"../../Shader/";
const static std::wstring kSoundPath = L"../../Resource/Sound/";
...
const static std::wstring kUIPath = L"../../Resource/Texture/Data/UI/";
